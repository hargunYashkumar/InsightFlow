  ...
  tags$head(
    ...
    .info-panel {
      background: linear-gradient(rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.35)), 
                  url(https://raw.githubusercontent.com/hargunYashkumar/Data-analysis_using_R_and_Power-BI/main/img2.jpg);
    ...
    /* Video Background Styling */
     ...
     /* Google Auth Button Styling */
      ...
      .hero-section {
        background: linear-gradient(rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.35)),
                    url('https://github.com/hargunYashkumar/InsightFlow/blob/main/1.jpg');
        background-size: cover;
        background-position: center;
        height: 100vh;
        display: flex;
      ...
      .features-section {
        padding: 80px 20px;
        height:100vh;
        background: linear-gradient(rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.35)),url(https://github.com/hargunYashkumar/InsightFlow/blob/main/3.jpg);
        background-size: cover;
        background-position: center;
      }
      ...
      /* Team Section */
      .team-section {
        background: linear-gradient(rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.35)),url(https://github.com/hargunYashkumar/InsightFlow/blob/main/4.jpg);
        padding: 50px 50px;
        background-size: cover;
        height=100vh;
        background-position: center;
